#include <ros/ros.h>
#include "robot_odom/base_node.hpp"
...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    ros::Subscriber encoder_sub = nh.subscribe("base/encoder", 50, encoder_callback);
    ros::Subscriber imu_sub = nh.subscribe("imu/data", 50, imu_callback);
    ros::Publisher odom_pub = nh.advertise<nav_msgs::Odometry>("base/odom", 50);
